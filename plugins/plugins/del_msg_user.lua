...
send_large_msg(r, 'تم مسح جميع رسائل العضو \n\n #user @'..(msg.from.username or msg.from.print_name))
...
if matches[1]:lower() == 'مسح رسائل للاا' then
...
if matches[1]:lower() == 'مسح رسائل العضو' then
